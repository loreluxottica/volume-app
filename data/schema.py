...
NA_WEARABLES_BY_SITE: dict[str, dict[str, list[str]]] = {
    ...
    "TIJUANA": {
        "py":      ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "siop":    ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "mon_frc": ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "thu_frc": ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "fri_frc": ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "actual":  ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "eow_wip": ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
        "wip_ot":  ["inb_gtk", "inb_tri", "rop_labs", "whls_gross", "ds_na", "ecom", "dummy", "repl_el", "meta"],
    },
    "DONGGUAN": {
